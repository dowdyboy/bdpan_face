...
from bdpan_face.v4.dataset import FaceDataset
...
parser.add_argument('--ms', type=int, nargs='+', default=[768, 896, 0], help='multi scale crop')
# parser.add_argument('--ms', type=int, nargs='+', default=[128, 192, 0], help='multi scale crop')
parser.add_argument('--num-workers', type=int, default=0, help='num workers')
# optimizer config
parser.add_argument('--lr', type=float, default=4e-4, help='lr')
...
# train config
parser.add_argument('--iter', type=int, default=4500000, help='epoch num')
